...
#' @return The same tibble as input, with M-values, tensions and percent_gradient computed for all segments. Warning: at this stage, the values computed don't take into account any decompression stops. They will later be used to calculate the time needed for each deco stop.
